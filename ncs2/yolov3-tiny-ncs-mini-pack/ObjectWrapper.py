...
'''
    ...
    def Detect(self, frame, idx=0):
	    ...
	    start_time = time()
	    #------------------------------------------------------------------------------
	    exec_net.start_async(idx, inputs={input_blob: in_frame})
	    #------------------------------------------------------------------------------
	    #print('previous_request_id:{0};cur_request_id:{1}'.format(previous_request_id, cur_request_id))
	    #------------------------------------------------------------------------------

	    status = infer_requests[idx].wait()
	    if status is not 0:
	        raise Exception("Infer request not completed successfully")

	    output = exec_net.requests[idx].outputs
	    start_time = time()
	    nmsed_between_layer_results = parse_ncs2_yolov3_tiny_output(output, frame, self.detector)    
