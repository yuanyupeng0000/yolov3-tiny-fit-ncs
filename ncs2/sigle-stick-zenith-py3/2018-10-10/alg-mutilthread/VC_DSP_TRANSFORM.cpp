...
//	 RESULTMSG *p_outbuf=p_arg->p_outbuf;
	...
	int result[600]={0};
	Uint16 nboxes = ArithDetect(p_arg->pCfgs, pInFrameBuf, pInuBuf, pInvBuf, nWidth, nHeight, result);
